...
@task(help={"version": "oteapi-ontokb-plugin version to set"})
def setver(_, version=""):
    """Sets the oteapi-ontokb-plugin version."""
    match = re.fullmatch(
        (
    ...
    update_file(
        TOP_DIR / "oteapi_ontokb_plugin" / "__init__.py",
...
def create_api_reference_docs(context, pre_clean=False, pre_commit=False):
    ...
    package_dir = TOP_DIR / "oteapi_ontokb_plugin"
